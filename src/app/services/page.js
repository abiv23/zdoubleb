...
export const metadata = {
  title: "Window and Construction in Arvada",
  description: "Z Double B Construction offers comprehensive Window and Construction including commercial construction, residential construction, and renovation services in Arvada.",
};
...
const services = [
  {
    ...
    imageAlt: 'Commercial Window and Construction'
  },
  {
    id: 'residential',
    title: 'Residential Construction',
    shortDescription: 'Creating beautiful, functional homes that meet your exact specifications and exceed expectations.',
    description: 'Our residential Window and Construction focus on building high-quality homes that reflect your personal style and meet your family&apos;s needs. Whether you&apos;re looking to build a custom home or a spec home for resale, we have the expertise to bring your vision to life.',
    features: [
    ...
    imageAlt: 'Residential Window and Construction'
  },
  {
    id: 'renovation',
          ...
          <FadeIn>
            <div className="text-center">
              <p className="mt-2 text-3xl font-extrabold text-gray-900 sm:text-4xl">
                Expert Window and Construction in Arvada
              </p>
              <p className="mt-4 text-lg text-gray-500">
                At Z Double B Construction, we offer a wide range of Window and Construction to meet your needs. 
